...
class CycleViewSet(WebhookMixin, BaseViewSet):
    ...
    def create(self, request, slug, project_id):
        if (
            ...
            print("requestttt data ",request.data)
    ...
    def partial_update(self, request, slug, project_id, pk):
        ...
        print("requestttt partial  data ",request_data)
    ...
    def retrieve(self, request, slug, project_id, pk):
        ...
        print("erro rins ruwtiun",queryset)
        ...
        print("assifne sijd ",assignee_distribution)
        # Label Distribution
        label_distribution = (
            Issue.objects.filter(
                issue_cycle__cycle_id=pk,
        ...
        print("labens unf s",label_distribution)
        data = CycleSerializer(queryset).data
        print("Data is jd  eer",data)
        data["distribution"] = {
            "assignees": assignee_distribution,
            "labels": label_distribution,
            "completion_chart": {},
        }
        print("after data ",queryset.start_date)
