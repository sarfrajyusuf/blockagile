  ...
  const emptyStateProps: EmptyStateProps =
    issueFilterCount > 0
      ...
      : {
          ...
          comicBox: {
            title: "Issues are building blocks in BlockAgile.",
            description:
              "Redesign the BlockAgile UI, Rebrand the company, or Launch the new fuel injection system are examples of issues that likely have sub-issues.",
          },
          primaryButton: {
