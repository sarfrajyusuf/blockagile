...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The issue is the building block of the BlockAgile. Most concepts in BlockAgile are either associated with issues and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
          ...
          <div className="h-full overflow-hidden">
            ...
            <div className="flex h-2/5 flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-xl">
                Welcome to BlockAgile, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
